<div class="btn-toolbar">
    ...
    <div class="control-group">
        <label class="pull-right">
            Palavras-Chave: <input type="text" id="palavras_chave" value="<?= $model->palavras_chave ?>" onchange="$(this).attr('name', 'palavras_chave');" placeholder="Separadas por ponto e vírgula (;)" />
        </label>
    </div>
