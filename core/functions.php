...
function __autoload($class) {
    ...
    $files[2] = root . 'app/controllers/' . $class . '.php';
    $files[3] = root . 'app/helpers/' . $class . '.php';
    $files[4] = root . 'app/models/' . $class . '.php';
    ...
    foreach ($modules as $path) {
        $file = $path . strtolower(str_replace('_', 's/', $class)) . '.php';
